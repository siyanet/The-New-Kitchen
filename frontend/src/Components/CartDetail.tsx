...
//   return (
//     // <div className='fixed top-0 right-0 w-full h-full overflow-y-auto bg-white shadow-lg sm:w-1/2'>
...
//         <div className="bottom-0 p-4 text-black border-b-4 border-black">
...
// export default CartDetail;
  ...
  //     items: cartItems.map((item) => ({
  //       menu_id: item.menu_id,
  //       portion_id: item.selectedPortion.portion_id,
  //       quantity: item.quantity,
  //       note: item.note || '',
  //     })),
  //   };
