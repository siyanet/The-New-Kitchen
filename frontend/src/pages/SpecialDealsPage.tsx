...
//               <h1 className="text-lg font-normal text-white font-fredoka lg:text-xl lg:text-red">Special Deals</h1>
//               <h2 className="text-lg font-semibold text-white font-epilogue lg:text-black">Don&apos;t miss out on our exclusive offer</h2>
//               <p className="text-base font-normal text-gray-100 font-epilogue lg:text-black">Enjoy great savings on your favorite dishes and services. Grab these limited-time deals before they&apos;re gone!</p>
//             </div>
