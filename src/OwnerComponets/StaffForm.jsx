...
<div>
              <label className="block font-nunito text-lg font-bold text-black py-2">Phone Number</label>
              {user ? (
         ...
         <div>
           ...
           {errors.locationId && <p className="text-red text-xs mt-1">{errors.locationId}</p>}
         </div>
   
         <div>
           <label className="block font-nunito text-lg font-bold text-black py-2">Schedule:</label>
...
{/* {user && (
              <div className="mb-4">
                <label className="block font-nunito text-lg font-bold text-black py-2">Select User:</label>
                <select
                  name="selectedUserId"
                ...
                {errors.selectedUserId && <p className="text-red text-xs mt-1">{errors.selectedUserId}</p>}
              </div>
            )} */}
